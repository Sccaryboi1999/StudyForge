  ...
  return <>
    ...
    {step === 2 && <div className="panel">
      ...
      <div className="panel-body">
        ...
        <div className="card" style={{ boxShadow: "none", marginBottom: 20, padding: 16, display: "flex", gap: 12, alignItems: "flex-start" }}>
          <Info size={19} style={{ flex: "0 0 auto", marginTop: 2 }} />
          <div><strong>Quiz relevance</strong><p className="small muted" style={{ margin: "4px 0 0" }}>StudyForge uses subject facts, definitions, processes, examples, and explained answers. It ignores repeated headers, page labels, contents, directions, scoring, and review instructions. Existing questions are treated as prompts; an explained answer key is treated as the authoritative source.</p></div>
        </div>
